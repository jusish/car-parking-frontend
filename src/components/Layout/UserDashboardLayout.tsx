...
export function UserDashboardLayout() {
  ...
  const sidebarItems = [
    ...
    { icon: PackageOpen, label: 'Parking Slots', to: '/user/slots' },
    { icon: Car, label: 'My Vehicles', to: '/user/vehicles' },
    { icon: Calendar, label: 'My Orders', to: '/user/orders' },
    { icon: User, label: 'My Profile', to: '/user/profile' },
  ];
